...
class Livros(Modelo):
    @classmethod
    def salvar(cls):
        with open("/workspaces/Proj_POO_Biblioteca/Arquivos/livros.json", mode="w") as arquivo:
    ...
    def abrir(cls):
        cls.objetos = []
        try:
            with open("/workspaces/Proj_POO_Biblioteca/Arquivos/livros.json", mode="r") as arquivo:
